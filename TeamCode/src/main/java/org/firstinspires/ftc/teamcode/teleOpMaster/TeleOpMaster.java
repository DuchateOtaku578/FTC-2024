    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()){
            ...
            if (robot.motor_1.isBusy() == false && gamepad2.left_trigger < 0.9){
                if (gamepad2.a)
                    elevador.girar_0(0.6);
                else if (gamepad2.x)
                    elevador.girar_1(0.6);
                else if (gamepad2.y)
                    elevador.girar_2(0.6);
                else if (gamepad2.b)
                    elevador.girar_3(0.6);
            }
            ...
            if (stickIzquierdoY_2 >0.5 && elevador.elevador.getCurrentPosition() < pulsosTopeSuperior) {
            ...
            else if (stickIzquierdoY_2 <-0.5 && elevador.elevador.getCurrentPosition() > pulsosTopeInferior) {
                robot.motor.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
